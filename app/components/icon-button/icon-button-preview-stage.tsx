        ...
        <div className="w-full grid grid-cols-1 min-[420px]:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-2.5">
          ...
          <StageControlSelect
            ...
            options={[
              ...
              { label: "Showcase (100px Reference)", value: "showcase" },
            ]}
          />
        ...
        {size === "showcase" ? (
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10 py-4">
            <div className="flex flex-col items-center gap-2">
              <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Canonical .box Reference</span>
              <div className="box">
            ...
            <div className="flex flex-col items-center gap-2">
              <span className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">HaloUI IconButton (100px)</span>
              <IconButton
                variant={variant}
                size="showcase"
                disabled={disabled}
