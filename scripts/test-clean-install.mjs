...
const itemsToTest = ["button", "icon-button", "button-group", "split-button", "toggle", "toggle-group", "floating-action-button", "copy-button", "favorite-button", "segmented-control", "action-bar", "field", "field-group", "label", "input", "input-group", "textarea", "native-select", "select", "combobox", "multi-select", "checkbox", "checkbox-group", "radio-group", "switch", "slider", "range-slider", "input-otp", "number-field", "currency-field", "phone-field", "url-field", "tag-input", "file-input", "file-upload", "color-picker", "rating-input", "date-picker", "date-range-picker", "time-picker", "date-time-picker", "calendar", "form-message", "tabs", "breadcrumb", "pagination"];
