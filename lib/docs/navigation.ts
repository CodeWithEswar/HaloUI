  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/components/tree-navigation",
    ...
    items: [
      {
        ...
        description: "An accessible modal task surface engineered with HaloUI liquid glass physical optics, calibrated optical scrim diffusion, and strict focus trapping.",
        status: "stable",
        keywords: [
          "dialog",
          "modal",
      ...
      },
      {
        ...
        description: "A high-consequence confirmation modal that interrupts the user with urgent information and requires explicit acknowledgement before proceeding.",
        status: "stable",
        keywords: [
          "alert-dialog",
          "alert dialog",
      ...
      },
      {
        ...
        description: "An edge-anchored overlay panel engineered with HaloUI liquid glass physical optics, directional slide kinematics, and concentric meniscus geometry.",
        status: "stable",
        keywords: [
          "sheet",
          "drawer",
      ...
      },
      {
        ...
        description: "A touch-friendly contextual surface powered by Base UI Drawer, engineered with velocity swipe dismissal, multi-step snap points, and 10-layer Liquid Glass optical physics.",
        status: "stable",
        keywords: [
          "drawer",
          "bottom sheet",
      ...
      },
      {
        ...
        description: "Button-triggered temporary action menu presenting contextual commands and choices, engineered with HaloUI Balanced Liquid Glass optics, composite WAI-ARIA menu semantics, and roving focus.",
        status: "stable",
        keywords: [
          "dropdown-menu",
          "dropdown menu",
      ...
      },
      {
        ...
        description: "Search-driven command collection surface engineered with cmdk filtering, roving keyboard navigation, HaloUI Liquid Glass optics, and zero competing engine duplication.",
        status: "stable",
        keywords: [
          "command-menu",
          "command menu",
      ...
      },
      {
        ...
        description: "Immersive media viewing overlay engineered with deep Halo Scrim backdrop attenuation, 100% media fidelity preservation, and floating liquid glass controls.",
        status: "stable",
        keywords: [
          "lightbox",
          "media viewer",
