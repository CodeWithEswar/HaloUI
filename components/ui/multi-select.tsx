    ...
    <ComboboxPrimitive.Portal>
      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            // HaloUI Physical Optical Liquid Glass Engine (Button Specification with elevated backdrop opacity)
            ...
            // Anchoring contact & ambient shadows
            "shadow-[0_16px_40px_-8px_rgba(0,0,0,0.14),0_2px_8px_-2px_rgba(0,0,0,0.06)]",
            "dark:shadow-[0_24px_58px_-10px_rgba(0,0,0,0.8),0_4px_16px_-4px_rgba(0,0,0,0.5)]",
            // Micro animation
